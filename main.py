...
model_pos_train = GraphDiffu(args, joints_left, joints_right, is_train=True)
model_pos_test_temp = GraphDiffu(args,joints_left, joints_right, is_train=False)
model_pos = GraphDiffu(args,joints_left, joints_right,  is_train=False, num_proposals=args.num_proposals, sampling_timesteps=args.sampling_timesteps)
model_pos = GraphDiffu(args,joints_left, joints_right,  is_train=False, num_proposals=args.num_proposals, sampling_timesteps=args.sampling_timesteps)
