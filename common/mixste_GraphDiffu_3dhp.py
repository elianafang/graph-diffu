...
class Graph:
    def __init__(self, dataset, labeling_mode='spatial'):
        if dataset == 'h36m':
            ...
            num_node = 17
            self_link = [(i, i) for i in range(num_node)]
            inward_ori_index = [(2, 1), (3, 2), (4, 3), (5, 4), (6, 2), (7, 6), (8, 7), (16, 2), (16, 15), (15, 12),
                                (15, 9), (13, 12), (14, 13), (10, 9), (11, 10), (17, 2)]
        else:
        ...
        self.neighbor = inward + outward  # All neighbor information
...
class  MixSTE2(nn.Module):
    def __init__(self, num_frame=9, num_joints=17, in_chans=2, embed_dim_ratio=32, depth=4,
        ...
        ctx_vectors_subject = torch.empty((9-self.remain_len_subject), 512, dtype=self.clip_text.dtype)
        nn.init.normal_(ctx_vectors_subject, std=0.02)
        self.ctx_subject = nn.Parameter(ctx_vectors_subject)

        ctx_vectors_speed = torch.empty((12-self.remain_len_verb), 512, dtype=self.clip_text.dtype)
